        ...
        <v-row class="px-1 py-0">
          ...
          <v-col cols="6">
            <v-text-field
              ...
              outlined
              color="primary"
              :label="frappe._('الضرائب والمصروفات')"
              background-color="white"
              hide-details
          ...
          <v-col cols="6">
            <v-text-field
              ...
              outlined
              color="primary"
              :label="frappe._('المبلغ الإجمالي')"
              background-color="white"
              hide-details
